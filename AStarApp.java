...
public class AStarApp {
    ...
    /**
     *внутренний класс обрабатывает события мыши. Изменяет ячейки в зависимости от состояния кнопки мыши
     **/
    private class MapCellHandler implements MouseListener
    {
        /**
         *значение будет истинным, если была нажата кнопка мыши
         **/
        private boolean modifying;
        
        /**
         * В зависимости от исходного значения делает ячейки
         * либо проходимыми, либо нет
         **/
        ...
        public void mousePressed(MouseEvent e)
        {
            ...
            // Непосредственное изменение состояния ячейки.
        ...
        /**
         * Если мышь была зажата, то это продолжит операцю изменения ячеек
         **/
        ...
        {
            // нужно для программы, игнорируем.
        }
    ...
    private void initGUI()
    {
        ...
        /* GridBagLayout учитывает предпочтительный размер,
    ...
    /**
     * Вспомогательный метод пытается вычислить путь, используя текущее состояние карты.
     **/
    private void findAndShowPath()
    {
        ...
        // Пробует вычислить путь.
        // Выбранный ячейки пути помечает.
